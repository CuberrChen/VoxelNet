...
cfg.model.voxelnet.loss.localization_weight = 2.0

cfg.model.voxelnet.loss.classification_loss = EasyDict()
cfg.model.voxelnet.loss.classification_loss.classification_loss_type = "weighted_sigmoid"
...
# Loss
cfg.model.voxelnet.pos_class_weight = 1.0
...
cfg.model.voxelnet.nms_score_threshold = 0.3  # 0.4 in submit, but 0.3 can get better hard performance
...
cfg.train_input_reader.global_rotation_uniform_noise = [-0.78539816, 0.78539816]
...
cfg.train_config.optimizer.optimizer_type = "adam_optimizer"
cfg.train_config.optimizer.use_moving_average = False

cfg.train_config.optimizer.adam_optimizer = EasyDict()
cfg.train_config.optimizer.adam_optimizer.weight_decay = 0.0001

cfg.train_config.optimizer.adam_optimizer.learning_rate = EasyDict()
cfg.train_config.optimizer.adam_optimizer.learning_rate.learning_rate_type = "polynomial_decay_learning_rate"
cfg.train_config.optimizer.adam_optimizer.learning_rate.polynomial_decay_learning_rate = EasyDict()
cfg.train_config.optimizer.adam_optimizer.learning_rate.polynomial_decay_learning_rate.initial_learning_rate = 0.0002
cfg.train_config.optimizer.adam_optimizer.learning_rate.polynomial_decay_learning_rate.decay_steps = 18570
cfg.train_config.optimizer.adam_optimizer.learning_rate.polynomial_decay_learning_rate.decay_factor = 0.8
...
cfg.train_config.loss_scale_factor = 512.0
