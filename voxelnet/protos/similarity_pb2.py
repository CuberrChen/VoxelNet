...
# source: voxelnet/protos/similarity.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='voxelnet/protos/similarity.proto',
...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.RegionSimilarityCalculator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='rotate_iou_similarity', full_name='voxelnet.protos.RegionSimilarityCalculator.rotate_iou_similarity', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='nearest_iou_similarity', full_name='voxelnet.protos.RegionSimilarityCalculator.nearest_iou_similarity', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='distance_similarity', full_name='voxelnet.protos.RegionSimilarityCalculator.distance_similarity', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='region_similarity', full_name='voxelnet.protos.RegionSimilarityCalculator.region_similarity',
...
_ROTATEIOUSIMILARITY = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.RotateIouSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_NEARESTIOUSIMILARITY = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.NearestIouSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_DISTANCESIMILARITY = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.DistanceSimilarity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='distance_norm', full_name='voxelnet.protos.DistanceSimilarity.distance_norm', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='with_rotation', full_name='voxelnet.protos.DistanceSimilarity.with_rotation', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rotation_alpha', full_name='voxelnet.protos.DistanceSimilarity.rotation_alpha', index=2,
...
RegionSimilarityCalculator = _reflection.GeneratedProtocolMessageType('RegionSimilarityCalculator', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.similarity_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.RegionSimilarityCalculator)
  ))
...
RotateIouSimilarity = _reflection.GeneratedProtocolMessageType('RotateIouSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.similarity_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.RotateIouSimilarity)
  ))
...
NearestIouSimilarity = _reflection.GeneratedProtocolMessageType('NearestIouSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.similarity_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.NearestIouSimilarity)
  ))
...
DistanceSimilarity = _reflection.GeneratedProtocolMessageType('DistanceSimilarity', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.similarity_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.DistanceSimilarity)
  ))
