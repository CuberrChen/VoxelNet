...
# source: voxelnet/protos/input_reader.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='voxelnet/protos/input_reader.proto',
...
_INPUTREADER = _descriptor.Descriptor(
  name='InputReader',
  full_name='voxelnet.protos.InputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='record_file_path', full_name='voxelnet.protos.InputReader.record_file_path', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='class_names', full_name='voxelnet.protos.InputReader.class_names', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='voxelnet.protos.InputReader.batch_size', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_num_epochs', full_name='voxelnet.protos.InputReader.max_num_epochs', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prefetch_size', full_name='voxelnet.protos.InputReader.prefetch_size', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_number_of_voxels', full_name='voxelnet.protos.InputReader.max_number_of_voxels', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_assigner', full_name='voxelnet.protos.InputReader.target_assigner', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kitti_info_path', full_name='voxelnet.protos.InputReader.kitti_info_path', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kitti_root_path', full_name='voxelnet.protos.InputReader.kitti_root_path', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shuffle_points', full_name='voxelnet.protos.InputReader.shuffle_points', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='groundtruth_localization_noise_std', full_name='voxelnet.protos.InputReader.groundtruth_localization_noise_std', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='groundtruth_rotation_uniform_noise', full_name='voxelnet.protos.InputReader.groundtruth_rotation_uniform_noise', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_rotation_uniform_noise', full_name='voxelnet.protos.InputReader.global_rotation_uniform_noise', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_scaling_uniform_noise', full_name='voxelnet.protos.InputReader.global_scaling_uniform_noise', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove_unknown_examples', full_name='voxelnet.protos.InputReader.remove_unknown_examples', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_workers', full_name='voxelnet.protos.InputReader.num_workers', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anchor_area_threshold', full_name='voxelnet.protos.InputReader.anchor_area_threshold', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove_points_after_sample', full_name='voxelnet.protos.InputReader.remove_points_after_sample', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='groundtruth_points_drop_percentage', full_name='voxelnet.protos.InputReader.groundtruth_points_drop_percentage', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='groundtruth_drop_max_keep_points', full_name='voxelnet.protos.InputReader.groundtruth_drop_max_keep_points', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove_environment', full_name='voxelnet.protos.InputReader.remove_environment', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unlabeled_training', full_name='voxelnet.protos.InputReader.unlabeled_training', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_random_rotation_range_per_object', full_name='voxelnet.protos.InputReader.global_random_rotation_range_per_object', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='database_prep_steps', full_name='voxelnet.protos.InputReader.database_prep_steps', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='database_sampler', full_name='voxelnet.protos.InputReader.database_sampler', index=24,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_group_id', full_name='voxelnet.protos.InputReader.use_group_id', index=25,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unlabeled_database_sampler', full_name='voxelnet.protos.InputReader.unlabeled_database_sampler', index=26,
...
InputReader = _reflection.GeneratedProtocolMessageType('InputReader', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.InputReader)
  ))
