...
# source: voxelnet/protos/sampler.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='voxelnet/protos/sampler.proto',
...
_GROUP_NAMETOMAXNUMENTRY = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.Group.NameToMaxNumEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='voxelnet.protos.Group.NameToMaxNumEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='voxelnet.protos.Group.NameToMaxNumEntry.value', index=1,
...
_GROUP = _descriptor.Descriptor(
  name='Group',
  full_name='voxelnet.protos.Group',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name_to_max_num', full_name='voxelnet.protos.Group.name_to_max_num', index=0,
...
_SAMPLER = _descriptor.Descriptor(
  name='Sampler',
  full_name='voxelnet.protos.Sampler',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='database_info_path', full_name='voxelnet.protos.Sampler.database_info_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sample_groups', full_name='voxelnet.protos.Sampler.sample_groups', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='database_prep_steps', full_name='voxelnet.protos.Sampler.database_prep_steps', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='global_random_rotation_range_per_object', full_name='voxelnet.protos.Sampler.global_random_rotation_range_per_object', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rate', full_name='voxelnet.protos.Sampler.rate', index=4,
...
Group = _reflection.GeneratedProtocolMessageType('Group', (_message.Message,), dict(
  ...
  NameToMaxNumEntry = _reflection.GeneratedProtocolMessageType('NameToMaxNumEntry', (_message.Message,), dict(
    ...
    __module__ = 'voxelnet.protos.sampler_pb2'
    # @@protoc_insertion_point(class_scope:voxelnet.protos.Group.NameToMaxNumEntry)
    ))
  ,
  DESCRIPTOR = _GROUP,
  __module__ = 'voxelnet.protos.sampler_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.Group)
  ))
...
Sampler = _reflection.GeneratedProtocolMessageType('Sampler', (_message.Message,), dict(
  DESCRIPTOR = _SAMPLER,
  __module__ = 'voxelnet.protos.sampler_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.Sampler)
  ))
