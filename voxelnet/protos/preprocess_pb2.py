...
# source: voxelnet/protos/preprocess.proto
...
_PREPROCESS = _descriptor.Descriptor(
  name='Preprocess',
  full_name='voxelnet.protos.Preprocess',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='random_global_rotation_min_rad', full_name='voxelnet.protos.Preprocess.random_global_rotation_min_rad', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='random_global_rotation_max_rad', full_name='voxelnet.protos.Preprocess.random_global_rotation_max_rad', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_global_scaling_min', full_name='voxelnet.protos.Preprocess.random_global_scaling_min', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_global_scaling_max', full_name='voxelnet.protos.Preprocess.random_global_scaling_max', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_noise_per_groundtruth_min_rad', full_name='voxelnet.protos.Preprocess.random_noise_per_groundtruth_min_rad', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_noise_per_groundtruth_max_rad', full_name='voxelnet.protos.Preprocess.random_noise_per_groundtruth_max_rad', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_noise_per_groundtruth_position_std', full_name='voxelnet.protos.Preprocess.random_noise_per_groundtruth_position_std', index=6,
...
_DATABASEPREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.DatabasePreprocessingStep',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='filter_by_difficulty', full_name='voxelnet.protos.DatabasePreprocessingStep.filter_by_difficulty', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filter_by_min_num_points', full_name='voxelnet.protos.DatabasePreprocessingStep.filter_by_min_num_points', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='database_preprocessing_step', full_name='voxelnet.protos.DatabasePreprocessingStep.database_preprocessing_step',
...
_DBFILTERBYDIFFICULTY = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.DBFilterByDifficulty',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='removed_difficulties', full_name='voxelnet.protos.DBFilterByDifficulty.removed_difficulties', index=0,
...
_DBFILTERBYMINNUMPOINTINGROUNDTRUTH_MINNUMPOINTPAIRSENTRY = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.DBFilterByMinNumPointInGroundTruth.MinNumPointPairsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='voxelnet.protos.DBFilterByMinNumPointInGroundTruth.MinNumPointPairsEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='voxelnet.protos.DBFilterByMinNumPointInGroundTruth.MinNumPointPairsEntry.value', index=1,
...
_DBFILTERBYMINNUMPOINTINGROUNDTRUTH = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.DBFilterByMinNumPointInGroundTruth',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_num_point_pairs', full_name='voxelnet.protos.DBFilterByMinNumPointInGroundTruth.min_num_point_pairs', index=0,
...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.PreprocessingStep',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='random_global_scaling', full_name='voxelnet.protos.PreprocessingStep.random_global_scaling', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_global_rotation', full_name='voxelnet.protos.PreprocessingStep.random_global_rotation', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='preprocessing_step', full_name='voxelnet.protos.PreprocessingStep.preprocessing_step',
      index=0, containing_type=None, fields=[]),
  ],
...
_RANDOMGLOBALSCALING = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.RandomGlobalScaling',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_scale', full_name='voxelnet.protos.RandomGlobalScaling.min_scale', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_scale', full_name='voxelnet.protos.RandomGlobalScaling.max_scale', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RANDOMGLOBALROTATION = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.RandomGlobalRotation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_rad', full_name='voxelnet.protos.RandomGlobalRotation.min_rad', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_rad', full_name='voxelnet.protos.RandomGlobalRotation.max_rad', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Preprocess = _reflection.GeneratedProtocolMessageType('Preprocess', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.preprocess_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.Preprocess)
  ))
...
DatabasePreprocessingStep = _reflection.GeneratedProtocolMessageType('DatabasePreprocessingStep', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.preprocess_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.DatabasePreprocessingStep)
  ))
...
DBFilterByDifficulty = _reflection.GeneratedProtocolMessageType('DBFilterByDifficulty', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.preprocess_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.DBFilterByDifficulty)
  ))
...
DBFilterByMinNumPointInGroundTruth = _reflection.GeneratedProtocolMessageType('DBFilterByMinNumPointInGroundTruth', (_message.Message,), dict(
  ...
  MinNumPointPairsEntry = _reflection.GeneratedProtocolMessageType('MinNumPointPairsEntry', (_message.Message,), dict(
    ...
    __module__ = 'voxelnet.protos.preprocess_pb2'
    # @@protoc_insertion_point(class_scope:voxelnet.protos.DBFilterByMinNumPointInGroundTruth.MinNumPointPairsEntry)
    ))
  ,
  DESCRIPTOR = _DBFILTERBYMINNUMPOINTINGROUNDTRUTH,
  __module__ = 'voxelnet.protos.preprocess_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.DBFilterByMinNumPointInGroundTruth)
  ))
...
PreprocessingStep = _reflection.GeneratedProtocolMessageType('PreprocessingStep', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.preprocess_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.PreprocessingStep)
  ))
...
RandomGlobalScaling = _reflection.GeneratedProtocolMessageType('RandomGlobalScaling', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.preprocess_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.RandomGlobalScaling)
  ))
...
RandomGlobalRotation = _reflection.GeneratedProtocolMessageType('RandomGlobalRotation', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.preprocess_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.RandomGlobalRotation)
  ))
