...
# source: voxelnet/protos/model.proto
...
from voxelnet.protos import second_pb2 as second_dot_protos_dot_second__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='voxelnet/protos/model.proto',
...
_DETECTIONMODEL = _descriptor.Descriptor(
  name='DetectionModel',
  full_name='voxelnet.protos.DetectionModel',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='voxelnet', full_name='voxelnet.protos.DetectionModel.voxelnet', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='model', full_name='voxelnet.protos.DetectionModel.model',
...
DetectionModel = _reflection.GeneratedProtocolMessageType('DetectionModel', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.model_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.DetectionModel)
  ))
