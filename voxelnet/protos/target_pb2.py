...
# source: voxelnet/protos/target.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='voxelnet/protos/target.proto',
...
_TARGETASSIGNER = _descriptor.Descriptor(
  name='TargetAssigner',
  full_name='voxelnet.protos.TargetAssigner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchor_generators', full_name='voxelnet.protos.TargetAssigner.anchor_generators', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='sample_positive_fraction', full_name='voxelnet.protos.TargetAssigner.sample_positive_fraction', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sample_size', full_name='voxelnet.protos.TargetAssigner.sample_size', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_rotate_iou', full_name='voxelnet.protos.TargetAssigner.use_rotate_iou', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='class_name', full_name='voxelnet.protos.TargetAssigner.class_name', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='region_similarity_calculator', full_name='voxelnet.protos.TargetAssigner.region_similarity_calculator', index=5,
...
TargetAssigner = _reflection.GeneratedProtocolMessageType('TargetAssigner', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.target_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.TargetAssigner)
  ))
