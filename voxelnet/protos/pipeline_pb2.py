...
# source: voxelnet/protos/pipeline.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='voxelnet/protos/pipeline.proto',
...
_TRAINEVALPIPELINECONFIG = _descriptor.Descriptor(
  ...
  full_name='voxelnet.protos.TrainEvalPipelineConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='model', full_name='voxelnet.protos.TrainEvalPipelineConfig.model', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='train_input_reader', full_name='voxelnet.protos.TrainEvalPipelineConfig.train_input_reader', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='train_config', full_name='voxelnet.protos.TrainEvalPipelineConfig.train_config', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='eval_input_reader', full_name='voxelnet.protos.TrainEvalPipelineConfig.eval_input_reader', index=3,
...
TrainEvalPipelineConfig = _reflection.GeneratedProtocolMessageType('TrainEvalPipelineConfig', (_message.Message,), dict(
  ...
  __module__ = 'voxelnet.protos.pipeline_pb2'
  # @@protoc_insertion_point(class_scope:voxelnet.protos.TrainEvalPipelineConfig)
  ))
