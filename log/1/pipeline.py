...
cfg.model.voxelnet.loss.localization_weight = 2.0 # try 2.0
...
# Postprocess
cfg.model.voxelnet.post_center_limit_range = [0, -40, -3, 70.4, 40, 1]
...
cfg.train_input_reader.batch_size = 2  #  use 8.5 GB GPU memory when batch_size=2
cfg.train_input_reader.prefetch_size = 25
cfg.train_input_reader.max_number_of_voxels = 20000
...
cfg.train_config.optimizer.momentum_optimizer.learning_rate.polynomial_decay_learning_rate.initial_learning_rate = 0.0015
#0.01*2/16 ~=0.00125 #0.0002 in second
cfg.train_config.optimizer.momentum_optimizer.learning_rate.polynomial_decay_learning_rate.decay_steps = 296960 # 18570 in second
...
cfg.train_config.steps = 296960  # 1856 * 120
cfg.train_config.steps_per_eval = 9280  # 1856 * 5
